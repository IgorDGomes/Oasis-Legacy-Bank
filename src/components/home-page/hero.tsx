        ...
        <div className="grid grid-cols-2 max-w-[1440px] mx-auto min-h-[600px]">
            <div className="flex flex-col gap-20 items-center justify-center h-full">
                ...
                <div className="flex justify-evenly w-full">
                    <Link href='/sign-up' className="bg-orange-500 px-6 py-3 rounded-xl font-medium text-main hover:bg-orange-500/80 transition-colors duration-[400ms]">Create Account</Link>
                    <Link href='/support/contact' className="border-2 border-white bg-transparent px-6 py-2.5 rounded-xl font-medium text-white hover:bg-white hover:text-main transition-colors duration-[400ms]">Contact Us</Link>
                </div>
            </div>
